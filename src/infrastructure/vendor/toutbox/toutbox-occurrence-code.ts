 ...
 * `CANCELLED` is handled separately from the others by
 * `ToutboxProcessDeliveryWebhook` — it completes via wave-delivery-api's
 * private cancellation endpoint, not the generic PATCH the other two use.
 */
